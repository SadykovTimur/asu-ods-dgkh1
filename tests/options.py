def pytest_addoption(parser):
    group = parser.getgroup('asu-ods-dgkh')
    ...
    group.addoption(
        ...
        metavar='ui_url',
        default='ods.mos.ru/udo-odh/login',
    )
    ...
    parser.addoption('--user', action='store', dest='username', type=str, default='test_monitor', help='Username')
    parser.addoption('--password', action='store', dest='password', type=str, default='UJHYtvd56fF', help='Password')
